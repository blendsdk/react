 ...
 */
export const NotAuthenticated: React.FC<IAuthenticationProps> = observer<React.FC<IAuthenticationProps>>(
...
export const WithAuthentication: React.FC<IAuthenticationProps> = observer<React.FC<IAuthenticationProps>>(
    ({ redirectLocation, children }) => {
